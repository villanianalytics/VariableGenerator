...
To build the final jar and optimize the VariableGenerator application for production, run:
...
Then navigate to [http://localhost:8092](http://localhost:8092) in your browser.
