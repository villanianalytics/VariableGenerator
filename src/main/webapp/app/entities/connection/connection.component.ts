...
export class ConnectionComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    if (this.currentSearch) {
      this.connectionService
        ...
        .subscribe((res: HttpResponse<IConnection[]>) => this.paginateConnections(res.body, res.headers));
      return;
    }
  ...
  registerChangeInConnections(): void {
    this.eventSubscriber = this.eventManager.subscribe('connectionListModification', () => this.reset());
  }
  ...
  protected paginateConnections(data: IConnection[] | null, headers: HttpHeaders): void {
