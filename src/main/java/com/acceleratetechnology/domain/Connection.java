...
public class Connection implements Serializable {
    ...
    public ListUD getConnection() {
        return connection;
    }

    public Connection connection(ListUD listUD) {
        this.connection = listUD;
        return this;
    }

    public void setConnection(ListUD listUD) {
        this.connection = listUD;
    }
