...
import { VariableNameComponent } from 'app/entities/variable-name/variable-name.component';
...
describe('Component Tests', () => {
  describe('VariableName Management Component', () => {
    let comp: VariableNameComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VariableNameComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.variableNames && comp.variableNames[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
