...
import { CubesComponent } from 'app/entities/cubes/cubes.component';
import { CubesService } from 'app/entities/cubes/cubes.service';
import { Cubes } from 'app/shared/model/cubes.model';

describe('Component Tests', () => {
  describe('Cubes Management Component', () => {
    let comp: CubesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CubesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cubes && comp.cubes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
