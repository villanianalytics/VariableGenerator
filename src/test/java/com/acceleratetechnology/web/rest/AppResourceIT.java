...
public class AppResourceIT {
    ...
    private static final Boolean DEFAULT_DERIVED_VALUE = false;
    private static final Boolean UPDATED_DERIVED_VALUE = true;
    ...
    public static App createEntity(EntityManager em) {
        App app = new App()
            .derivedValue(DEFAULT_DERIVED_VALUE)
    ...
    public static App createUpdatedEntity(EntityManager em) {
        App app = new App()
            .derivedValue(UPDATED_DERIVED_VALUE)
    ...
    public void createApp() throws Exception {
        ...
        assertThat(testApp.isDerivedValue()).isEqualTo(DEFAULT_DERIVED_VALUE);
    ...
    public void getAllApps() throws Exception {
        ...
        restAppMockMvc.perform(get("/api/apps?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].derivedValue").value(hasItem(DEFAULT_DERIVED_VALUE.booleanValue())))
    ...
    public void getApp() throws Exception {
        ...
        restAppMockMvc.perform(get("/api/apps/{id}", app.getId()))
            ...
            .andExpect(jsonPath("$.derivedValue").value(DEFAULT_DERIVED_VALUE.booleanValue()))
    ...
    public void updateApp() throws Exception {
        ...
        App testApp = appList.get(appList.size() - 1);
        assertThat(testApp.isDerivedValue()).isEqualTo(UPDATED_DERIVED_VALUE);
